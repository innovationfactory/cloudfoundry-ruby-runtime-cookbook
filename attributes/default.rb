...
ruby18_path = File.join(node['rbenv']['system_prefix'], "rbenv", "versions", node['cloudfoundry_ruby_runtime']['ruby_1_8_7_version'], "bin")
...
default['cloudfoundry_dea']['runtimes']['ruby18']['executable']   = File.join(ruby18_path, "ruby")
...
default['cloudfoundry_dea']['runtimes']['ruby18']['environment']   = ["PATH: #{ruby18_path}:$PATH"]

ruby19_path = File.join(node['rbenv']['system_prefix'], "rbenv", "versions", node['cloudfoundry_ruby_runtime']['ruby_1_9_2_version'], "bin")
...
default['cloudfoundry_dea']['runtimes']['ruby19']['executable']   = File.join(ruby19_path, "ruby")
...
default['cloudfoundry_dea']['runtimes']['ruby19']['environment']   = ["PATH: #{ruby19_path}:$PATH"]
